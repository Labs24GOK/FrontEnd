...
export const getStaffTable = () => dispatch => {
    ...
    axios.get('http://localhost:4000/api?table=staff')
        .then(res => {
...
export const getStaffById = id => dispatch => {
    ...
    axios.get(`http://localhost:4000/api/?table=staff&where=id=${id}`)
    .then(res => {
        dispatch({
...
export const editStaffById = (id, state) => dispatch => {
    axios.put(`http://localhost:4000/api/?table=staff&where=id=${id}`, state)
    .then(res => {
        dispatch({
...
export const addStaff = staff => dispatch => {
    ...
    axios.post('http://localhost:4000/api?table=staff', staffNew)
        .then(res => {
