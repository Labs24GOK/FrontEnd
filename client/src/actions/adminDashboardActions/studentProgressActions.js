...
export const getStudentProgress = student_id => dispatch => {
    ...
    axios.get(`http://localhost:3001/api/?table=progress_report&where=student_id=${student_id}`)
    .then(res => { 
        dispatch({
...
export const postStudentProgress = student => dispatch => {
    axios.post('http://localhost:3001/api/?table=progress_report', student)
    .then(res => { 
...
export const editStudentProgress = (student_id, state) => dispatch => {
    ...
    axios.put(`http://localhost:3001/api/?table=progress_report&where=student_id=${student_id}`, state)
    .then(res => { 
