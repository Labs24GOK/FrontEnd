			...
			<FormSet>
				<Div>
					<div>
						<Label>ID</Label>
						<div>
							<Input type="text" placeholder="xxxxxxxxxx" border={errors.cpr && '2px solid red'} name="cpr" defaultValue={student.cpr} ref={register({required: true, minLength: 9, maxLength: 9})} />
					...
					<div>
						...
						<div>
							 <Input type="text" border={errors.first_name && '2px solid red'} name="first_name" defaultValue={student.first_name} ref={register({required: true, maxLength: 80})} />
					...
					<Label>Email</Label>
						<div>
							<Input type="text" border={errors.email && '2px solid red'} name="email" defaultValue={student.email} ref={register({required: true, pattern: /^\S+@\S+$/i})} />
					...
					<div>
						...
						<div>
							<Input type="date" border={errors.birthdate && '2px solid red'} name="birthdate" defaultValue={birthdate} ref={register({required: true})} />
					...
					<div>
						...
						<div>
							<Input type="text" border={errors.school_name && '2px solid red'}  name="school_name" defaultValue={student.school_name} ref={register({required: true})} />
