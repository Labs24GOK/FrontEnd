  ...
  return (
    ...
    {console.log(student)}
      ...
      <p style={{ padding: "0 5% 5% 5%" }}>
        عزيزي الطالب، نحن متحمسون للغاية لأنك قمت بالتسجيل للانضمام إلينا في
        Garden of Knowledge. نجعل التعلم فعالًا وممتعًا ، ولا يمكننا الانتظار
        لرؤيتك في الصف. اختبار تحديد المستوى لمعرفة مستواك. لا تقلق إذا كنت لا
        تعرف الإجابة ، فقط اتركها فارغة أولياء الأمور ، من فضلكم عدم مساعدة
        الطالب في الإجابه ، وعدم القراءة أيضا . إلا إذا لم يتمكن من القراءة حتى
      ...
      <Button style={{ marginLeft: '40%' }} onClick={() => dispatch(startTest(student))}>Next</Button>
    </>
  );
};
